                          ...
                          <div key={p.id} className="rounded-xl border border-gray-100 p-3 bg-white flex justify-between items-center shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {p.duplo && (
 <span className="text-[10px] font-bold px-2 py-0.5 rounded-full md:rounded-full inline-block mt-1 md:mt-0 whitespace-nowrap" style={{ backgroundColor: '#f6f5ea', color: '#5f6443', border: '1px solid #e2dfcc' }}>
